...
class ResourcesContainerWidget extends StatefulWidget {
  ...
  @override
  State<ResourcesContainerWidget> createState() => _ResourcesContainerWidgetState();
}
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.resourcetype == "file" || widget.resourcetype == 'pdf' || widget.resourcetype == 'video' ? widget.fileSize! : "",
                          style: GoogleFonts.notoSansDevanagari(
                            fontSize: 10,
                            color: ColorResources.gray,
                          ),
            ...
            widget.localcheck && Localfilesfind.localfiles.contains(widget.title)
                ...
                : InkWell(
                    ...
                    child: Column(
                      children: [
                        Text(
                          widget.resourcetype == "file" || widget.resourcetype == "pdf"
                              ? 'PDF'
                              : widget.resourcetype == "video" || widget.resourcetype == "yt_videos"
                                  ? "Play"
                                  : 'Link',
                          style: GoogleFonts.notoSansDevanagari(
                            fontSize: 15,
