...
class ListOfNotesScreen extends StatelessWidget {
  final String batchId;
  final String subjectId;
  final Data datas;
  const ListOfNotesScreen({super.key, required this.batchId, required this.subjectId, required this.datas});
  @override
  Widget build(BuildContext context) {
    analytics.logScreenView(
      screenName: "ListOfNotesScreen",
      parameters: {
        "batchId": batchId,
        "subjectId": subjectId,
      },
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          future: RemoteDataSourceImpl().getnotesbeforebatch(batchid: batchId, subjectId: subjectId),
                                      ...
                                      onTap: () {
                                        if (data?.file?.fileLoc?.trim().isEmpty ?? true) {
                                          ...
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => PdfRenderScreen(name: data?.resourceTitle ?? "", filePath: data?.file?.fileLoc ?? "", isoffline: false),
                                              ));
                                        }
                                      },
                                      child: Container(
